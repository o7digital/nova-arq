...
const translations = {
  ...
  it: { categories: ['Tutti','Architettura','Interni','Ristrutturazione'], filter: 'Filtra i progetti', titles: ['Pranzo & luce','Suite padronale','Architettura & Ristrutturazioni','Arredi & ritmo','Colore & carattere','I nostri progetti'], types: ['Spazio residenziale','Interior design','Ristrutturazione integrale','Design su misura','Soggiorno','Architettura e interni'], previous: 'Foto precedente', next: 'Foto successiva', feature: { eyebrow: 'Studio di architettura a Città del Messico', title: 'Progettiamo spazi durevoli, precisi e ricchi di identità.', paragraphs: ['Lo studio RHEO realizza progetti di architettura residenziale, interior design, decorazione e ristrutturazione integrale a Città del Messico e in tutto il Messico.', 'Dalle nuove costruzioni alla trasformazione completa di un’abitazione, coordiniamo concept, distribuzione, materiali, illuminazione, arredi su misura, budget, fornitori e direzione lavori.'], link: 'Scopri i nostri servizi' } },
