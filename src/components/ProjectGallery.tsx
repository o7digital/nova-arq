...
const projects = [
  ...
  },
  {
    id: '02',
    category: 'Interiores',
    title: 'Remodelacion y Redecoracion',
    ...
    images: [
      ...
      '/assets/raquel-projects/gallery/remodelacion-bano-ducha.webp',
    ],
    layout: 'tall',
  },
  {
...
const translations = {
  es: { categories: ['Todos','Arquitectura','Interiores','Remodelación'], filter: 'Filtrar selección de proyectos', titles: ['Interiores','Remodelacion y Redecoracion','Espacios Recreativos','Color & carácter','Nuestros Proyectos'], types: ['Espacio residencial','Interiorismo residencial','Remodelación integral','Sala de estar','Arquitectura e interiorismo'], previous: 'Foto anterior', next: 'Foto siguiente', feature: { eyebrow: 'Estudio de arquitectura en Ciudad de México', title: 'Diseñamos espacios con identidad, precisión y permanencia.', paragraphs: ['El estudio RHEO crea proyectos de arquitectura residencial, interiorismo, decoración y remodelación integral en Ciudad de México y otros destinos de México.', 'Desde una obra nueva hasta la transformación completa de una vivienda, coordinamos concepto, distribución, materiales, iluminación, mobiliario a medida, presupuesto, proveedores y supervisión de obra.'], link: 'Conocer nuestros servicios' } },
  en: { categories: ['All','Architecture','Interiors','Renovation'], filter: 'Filter selected projects', titles: ['Dining & light','Primary suite','Architecture & Renovations','Colour & character','Our Projects'], types: ['Residential space','Residential interiors','Complete renovation','Living room','Architecture and interiors'], previous: 'Previous photo', next: 'Next photo', feature: { eyebrow: 'Architecture studio in Mexico City', title: 'We design enduring spaces with identity and precision.', paragraphs: ['RHEO Studio creates residential architecture, interior design, decoration and complete renovation projects in Mexico City and across Mexico.', 'From new homes to the complete transformation of an existing property, we coordinate concept, spatial planning, materials, lighting, bespoke furniture, budgets, suppliers and construction supervision.'], link: 'Explore our services' } },
  fr: { categories: ['Tous','Architecture','Intérieurs','Rénovation'], filter: 'Filtrer les projets', titles: ['Salle à manger & lumière','Suite principale','Architecture & Rénovations','Couleur & caractère','Nos projets'], types: ['Espace résidentiel','Architecture intérieure','Rénovation intégrale','Salon','Architecture et intérieurs'], previous: 'Photo précédente', next: 'Photo suivante', feature: { eyebrow: 'Studio d’architecture à Mexico', title: 'Nous créons des espaces durables, précis et singuliers.', paragraphs: ['Le studio RHEO conçoit des projets d’architecture résidentielle, d’architecture intérieure, de décoration et de rénovation intégrale à Mexico et ailleurs au Mexique.', 'De la construction neuve à la transformation complète d’un logement, nous coordonnons concept, distribution, matériaux, éclairage, mobilier sur mesure, budget, fournisseurs et suivi de chantier.'], link: 'Découvrir nos services' } },
  it: { categories: ['Tutti','Architettura','Interni','Ristrutturazione'], filter: 'Filtra i progetti', titles: ['Pranzo & luce','Suite padronale','Architettura & Ristrutturazioni','Colore & carattere','I nostri progetti'], types: ['Spazio residenziale','Interior design','Ristrutturazione integrale','Soggiorno','Architettura e interni'], previous: 'Foto precedente', next: 'Foto successiva', feature: { eyebrow: 'Studio di architettura a Città del Messico', title: 'Progettiamo spazi durevoli, precisi e ricchi di identità.', paragraphs: ['Lo studio RHEO realizza progetti di architettura residenziale, interior design, decorazione e ristrutturazione integrale a Città del Messico e in tutto il Messico.', 'Dalle nuove costruzioni alla trasformazione completa di un’abitazione, coordiniamo concept, distribuzione, materiali, illuminazione, arredi su misura, budget, fornitori e direzione lavori.'], link: 'Scopri i nostri servizi' } },
  de: { categories: ['Alle','Architektur','Interieur','Sanierung'], filter: 'Projekte filtern', titles: ['Esszimmer & Licht','Master Suite','Architektur & Sanierungen','Farbe & Charakter','Unsere Projekte'], types: ['Wohnraum','Wohninterieur','Komplettsanierung','Wohnzimmer','Architektur und Interieur'], previous: 'Vorheriges Foto', next: 'Nächstes Foto', feature: { eyebrow: 'Architekturstudio in Mexiko-Stadt', title: 'Wir gestalten beständige Räume mit Identität und Präzision.', paragraphs: ['Das Studio RHEO entwickelt Wohnarchitektur, Innenarchitektur, Dekoration und ganzheitliche Sanierungen in Mexiko-Stadt und in ganz Mexiko.', 'Vom Neubau bis zur vollständigen Transformation eines Hauses koordinieren wir Konzept, Raumplanung, Materialien, Beleuchtung, Maßmöbel, Budget, Partner und Bauaufsicht.'], link: 'Unsere Leistungen entdecken' } },
  pt: { categories: ['Todos','Arquitetura','Interiores','Remodelação'], filter: 'Filtrar projetos', titles: ['Sala de jantar & luz','Suíte principal','Arquitetura e Remodelações','Cor & caráter','Nossos projetos'], types: ['Espaço residencial','Interiores residenciais','Remodelação integral','Sala de estar','Arquitetura e interiores'], previous: 'Foto anterior', next: 'Foto seguinte', feature: { eyebrow: 'Estúdio de arquitetura na Cidade do México', title: 'Criamos espaços duradouros com identidade e precisão.', paragraphs: ['O estúdio RHEO desenvolve projetos de arquitetura residencial, interiores, decoração e remodelação integral na Cidade do México e em todo o México.', 'De novas construções à transformação completa de uma casa, coordenamos conceito, distribuição, materiais, iluminação, mobiliário sob medida, orçamento, fornecedores e supervisão de obra.'], link: 'Conhecer os nossos serviços' } },
} as const;
...
const renovationFeatures = {
  es: {
    ...
    paragraphs: [
      'Cada remodelación comienza con una lectura precisa del espacio: su estructura, circulación, luz natural y potencial. RHEO replantea la arquitectura para adaptarla a la vida actual sin perder la identidad del lugar.',
  ...
  en: {
    ...
    paragraphs: [
      'Every renovation begins with a precise reading of the building: its structure, circulation, natural light and potential. RHEO reshapes the architecture for contemporary life while preserving the identity of the place.',
  ...
  fr: {
    ...
    paragraphs: [
      'Chaque rénovation commence par une lecture précise du lieu : structure, circulation, lumière naturelle et potentiel. RHEO repense l’architecture pour la vie contemporaine tout en préservant l’identité du bâti.',
  ...
  it: {
    ...
    paragraphs: [
      'Ogni ristrutturazione nasce da una lettura precisa dello spazio: struttura, percorsi, luce naturale e potenziale. RHEO ripensa l’architettura per la vita contemporanea preservando l’identità del luogo.',
  ...
  de: {
    ...
    paragraphs: [
      'Jede Sanierung beginnt mit einer präzisen Analyse von Struktur, Wegen, Tageslicht und Potenzial. RHEO entwickelt die Architektur für heutige Lebensweisen weiter und bewahrt zugleich die Identität des Ortes.',
  ...
  pt: {
    ...
    paragraphs: [
      'Cada remodelação começa com uma leitura precisa do espaço: estrutura, circulação, luz natural e potencial. RHEO repensa a arquitetura para a vida contemporânea, preservando a identidade do lugar.',
...
const interiorFeatures = {
  es: {
    '04': {
      ...
      paragraphs: [
        'El estudio RHEO diseña interiores donde arquitectura y mobiliario se resuelven como un solo conjunto. Cada proporción, recorrido y pieza responde a la forma de vivir de sus habitantes.',
    ...
    '05': {
      ...
      paragraphs: [
        'RHEO transforma salas y áreas sociales mediante una composición sensible de color, texturas, arte, luz y mobiliario. El objetivo es crear interiores personales que se sientan vivos y coherentes.',
  ...
  en: {
    '04': {
      ...
      paragraphs: [
        'RHEO Studio creates interiors where architecture and furniture are conceived as one. Every proportion, route and piece responds to the way its residents live.',
    ...
    '05': {
      ...
      paragraphs: [
        'RHEO transforms living rooms and social spaces through a sensitive composition of colour, texture, art, light and furniture. The aim is to create personal interiors that feel alive and coherent.',
  ...
  fr: {
    '04': {
      ...
      paragraphs: [
        'Le studio RHEO conçoit des intérieurs où architecture et mobilier forment un seul ensemble. Chaque proportion, circulation et pièce répond à la manière de vivre de ses habitants.',
    ...
    '05': {
      ...
      paragraphs: [
        'RHEO transforme salons et espaces de réception par une composition sensible de couleurs, textures, art, lumière et mobilier. L’objectif est de créer des intérieurs personnels, vivants et cohérents.',
  ...
  it: {
    '04': {
      ...
      paragraphs: [
        'Lo studio RHEO crea interni in cui architettura e arredi sono pensati come un unico insieme. Ogni proporzione, percorso e pezzo risponde al modo di vivere di chi abita lo spazio.',
    ...
    '05': {
      ...
      paragraphs: [
        'RHEO trasforma soggiorni e spazi sociali attraverso una composizione sensibile di colore, texture, arte, luce e arredi. L’obiettivo è creare interni personali, vivi e coerenti.',
  ...
  de: {
    '04': {
      ...
      paragraphs: [
        'Das Studio RHEO gestaltet Innenräume, in denen Architektur und Möbel als Einheit gedacht werden. Jede Proportion, Bewegung und Anfertigung folgt der Lebensweise der Bewohner.',
    ...
    '05': {
      ...
      paragraphs: [
        'RHEO verwandelt Wohn- und Gesellschaftsräume durch ein sensibles Zusammenspiel von Farbe, Textur, Kunst, Licht und Möbeln. So entstehen persönliche Interieurs, die lebendig und stimmig wirken.',
  ...
  pt: {
    '04': {
      ...
      paragraphs: [
        'O estúdio RHEO cria interiores onde arquitetura e mobiliário são pensados como um único conjunto. Cada proporção, percurso e peça responde à forma de viver dos seus habitantes.',
    ...
    '05': {
      ...
      paragraphs: [
        'RHEO transforma salas e áreas sociais através de uma composição sensível de cor, texturas, arte, luz e mobiliário. O objetivo é criar interiores pessoais, vivos e coerentes.',
